...
class StudentRegisterDetailsView extends StatefulWidget {
  const StudentRegisterDetailsView({super.key});

  @override
  State<StudentRegisterDetailsView> createState() => _StudentRegisterDetailsViewState();
}

class _StudentRegisterDetailsViewState extends State<StudentRegisterDetailsView> {
                          ...
                          child: authController.isLoading.isTrue
                              ...
                              : ElevatedButton(
                                  ...
                                  onPressed: () {
                                        ...
                                        StudentProfileUpdateModel studentProfileUpdateModel =
                                            StudentProfileUpdateModel(
                                                currentCompany: currentCompanyController.text,
                                                city: cityController.text,
                                                designation:designation == null ? null : designation.id.toString(),
                                                address:
                                                ...
                                                requirement: requiremtsSelected == null
                                                        ? null
                                                        : requiremtsSelected.id,
                                                othersdepartment:
                                                    othersDepartmentController
                                                        .text,
                                                industries:industries == null ? null : industries.id.toString(),
                                                education:
                                                    educationController.text);
                                        authController
                                            .studentUpdateProfile(studentProfileUpdateModel);
                                    },
                                  child: const Text(
                                    'Register',
                                    style: TextStyle(
