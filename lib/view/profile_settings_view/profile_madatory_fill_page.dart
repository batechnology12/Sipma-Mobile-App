...
class SettingProfileMadatoryPage extends StatefulWidget {
  ...
  @override
  State<SettingProfileMadatoryPage> createState() => _SettingProfilePageState();
}

class _SettingProfilePageState extends State<SettingProfileMadatoryPage> {
  bool _value = false;
  ...
  setDefaullt() async {
    // authController.isEducationSelected(false);
                          ...
                          child: TextField(
                            decoration: InputDecoration(
                                ...
                                border: OutlineInputBorder(
                                    ...
                                    borderSide:
                                        const BorderSide(color: Colors.black))),
                            controller: profileController.tBioController,
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(10.0),
